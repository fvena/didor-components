...
export default {
  ...
  computed: {
    ...
    tabBarItemClass() {
      return [this.$slots.default ? 'az-tabBarItem--title' : '', this.active || this.routeActive ? 'az-tabBarItem--active' : ''];
    },

    tabBarItemStyle() {
      return {
        color: this.active || this.routeActive ? this.$parent.$options.propsData.activeColor : this.$parent.$options.propsData.inactiveColor,
      };
    },
  },
